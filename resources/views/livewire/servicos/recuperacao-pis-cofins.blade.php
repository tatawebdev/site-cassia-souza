                ...
                <div class="main-box">
                    ...
                    <div class="content1" data-aos="fade-up" data-aos-duration="700">
                        ...
                        <p class="text-size-16"></p>
                            Muitas empresas acabam pagando <strong>PIS e COFINS monofásicos além do necessário</strong>, sem perceber que esses valores podem ser recuperados de forma legal e estratégica.
                        </p>
                        </div>
                        <div class="content2" data-aos="fade-up" data-aos-duration="700">
                            ...
                            <p class="mb-0 text-white text-size-18"><strong>Recupere créditos e melhore seu fluxo de caixa</strong></p>
                        </div>
                        <p class="text text-size-16">
                            Nós analisamos as operações, identificamos <strong>créditos tributários legítimos</strong> e aplicamos a legislação vigente para <strong>transformar pagamentos indevidos em recursos que fortalecem o caixa da sua empresa</strong>.
                        </p>
                        <div class="content3" data-aos="fade-up" data-aos-duration="700">
                            ...
                            <p class="text text-size-16">
                                Com <strong>segurança jurídica</strong> e atuação especializada, ajudamos sua empresa a <strong>reduzir custos</strong>, ganhar fôlego financeiro e investir no que realmente importa: o crescimento do seu negócio.
