            ...
            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                <div class="main-box">
                    ...
                    <div class="content1" data-aos="fade-up" data-aos-duration="700">
                        ...
                        <p class="text-size-16">
                            Oferecemos assessoria jurídica especializada para ajudar empresários a compreender os
                            impactos da Reforma e a se adaptar com <strong>segurança, clareza e orientações
                                estratégicas.</strong>
                        </p>
                        ...
                        <ul class="text text-size-16">
                            <li>Análise dos principais pontos da Reforma Tributária e seus efeitos diretos na sua
                                empresa;</li>
